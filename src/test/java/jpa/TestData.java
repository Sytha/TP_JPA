	...
	public static final Operation STANDARD_OPERATION = 
		Operations.sequenceOf(
				...
				Operations.insertInto("spectacle")
				          ...
				          .values(1L, "Dernier coup de ciseaux", "Troupe des Mathurins", TypeSpectacle.DRAMA)
						  .values(2L, "Black City Tour 2", "Indochine", TypeSpectacle.SF)
				          .build(),
